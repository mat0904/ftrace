...
const syscall_t syscalls[] = {
    ...
    {181, "getpmsg", 5},
    {182, "putpmsg", 4},
    {183, "afs_syscall", SYSCALL_NOT_IMPLEMENTED},
    {184, "tuxcall", SYSCALL_NOT_IMPLEMENTED},
    {185, "security", SYSCALL_NOT_IMPLEMENTED},
    {186, "gettid", 0},
    {187, "readahead", 3},
    {188, "setxattr", 5},
    {189, "lsetxattr", 5},
    ...
    {213, "epoll_create", 1},
    {214, "epoll_ctl_old", SYSCALL_NOT_IMPLEMENTED},
    {215, "epoll_wait_old", SYSCALL_NOT_IMPLEMENTED},
    ...
    {234, "tgkill", 3},
    {235, "utimes", 2},
    {236, "vserver", SYSCALL_NOT_IMPLEMENTED},
    {237, "mbind", 6},
    {238, "set_mempolicy", 3},
    {239, "get_mempolicy", 5},
    {240, "mq_open", 4},
    ...
    {331, "pkey_free", 1},
    {332, "statx", 5},
    {333, "io_pgetevents", SYSCALL_NOT_IMPLEMENTED},
    {334, "rseq", SYSCALL_NOT_IMPLEMENTED},
    {335, "pkey_mprotect", 4}
};
